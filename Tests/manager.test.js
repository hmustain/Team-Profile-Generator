// Create a group of tests to test out to see if the properties and methods i set up in the lib folder are setup properly and working. For this "Engineer Test Folder" We will test out to see if engineer name, id, email which came over previously from employee as well as the new parameter created gitHub is functioning properly by calling that specific property with the method we created ie getName() should return the name I enter getId() should return the id i enter, getEmail() should return the email i enter getOfficeNumber() should return the Office Number i enter and getRole() should return the role of the employee in this case it should override and become engineer. Day 2 talked about how to write tests, so I went back to day 2, along with documentation and youtube videos and help from Tutor and askbcs to write test. Also note in order to run test I had to instal jest by putting npm i jest in the terminal https://www.npmjs.com/package/jest
